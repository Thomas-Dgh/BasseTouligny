<div id="cff-builder-app" class="cff-fb-fs cff-builder-app" :data-app-loaded="appLoaded ? 'true' : 'false'" :data-disable-pro="shouldDisableProFeatures ? 'true' : 'false'" :class="shouldDisableProFeatures == true && iscustomizerScreen ? 'cff-builder-app-lite-dismiss' : '' ">
	<?php
