<div class="cff-fb-types-ctn cff-fb-fs sb-box-shadow" v-if="viewsActive.selectedFeedSection == 'feedsType'">
	<div class="cff-fb-types cff-fb-fs">
		...
		<div class="cff-fb-types-list">
			<div class="cff-fb-type-el" v-for="(feedTypeEl, feedTypeIn) in feedTypes" :data-active="selectedFeed === feedTypeEl.type" @click.prevent.default="chooseFeedType('normal', feedTypeEl)" :data-type="feedTypeEl.type">
