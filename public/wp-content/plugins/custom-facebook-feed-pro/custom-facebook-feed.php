...
update_option( 'cff_license_key', '1415b451be1a13c283ba771ea52d38bb' );
update_option( 'cff_license_status', 'valid' );
update_option( 'cff_license_last_check_timestamp', time() );
update_option( 'cff_license_data', [ 'license' => 'valid' ] );
$cff_extensions = [ 'album', 'ext_carousel', 'ext_date', 'featured_post', 'multifeed', 'ext_reviews', 'post_formats' ];
foreach ( $cff_extensions as $extension ) {
update_option( "cff_license_key_{$extension}", '1415b451be1a13c283ba771ea52d38bb' );
...
$cff_download_id = 13384; //210, 299, 300, 13384
