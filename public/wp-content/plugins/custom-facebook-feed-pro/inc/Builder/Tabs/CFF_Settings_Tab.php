	...
	static function get_settings_filters_controls(){
		...
		$pro_controls = [
			[
				...
				'conditionHide'		=> true,
				'checkExtensionDimmed'	=> !self::$should_disable_pro_features ? null : 'advancedFilter',
				'checkExtensionPopup' => !self::$should_disable_pro_features ? null : 'advancedFilter',
